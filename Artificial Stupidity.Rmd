...
allData <- allData %>% bind_cols(textfeatures(allText))
...
# distance = dist(allData %>% select(-price))
# 
...
for (i in 2:20) {
  print(i)
  wss[i] <- sum(kmeans(allData, centers=i)$withinss)
  }
...
afterCluster %>% select(c(price, cluster)) %>% ggplot(aes(x = price, color = cluster)) + geom_density()
```
...
# selectFeatures <- trainData %>% head(5000)
# 
# 
# boruta_output <- Boruta(price ~ ., data=selectFeatures, pValue = 0.05, maxRuns = 100, doTrace = 2)
...
#         eta                    = 0.0435,
#         max_depth              = 12,
#         min_child_weight       = 1626,
#         gamma                  = 2.37,
#         subsample              = 0.714,
#         colsample_bytree       = 0.439,
#         max_delta_step         = 2.02,
#         tweedie_variance_power = 1.29,
#         objective = 'reg:tweedie',
#         eval_metric = 'rmse'
#       )
...
# [mbo] 0: eta=0.0435; gamma=6.31; max_depth=12; min_child_weight=1626; subsample=0.714; colsample_bytree=0.439; max_delta_step=2.02; tweedie_variance_power=1.29 : y = 57.8 : 426.4 secs : initdesign
# [mbo] 0: eta=0.0435; gamma=6.31; max_depth=16; min_child_weight=1626; subsample=0.714; colsample_bytree=0.439; max_delta_step=2.02; tweedie_variance_power=1.29 : y = 57.8 : 535.6 secs : initdesign
# [mbo] 10: eta=0.0058; gamma=1.02; max_depth=15; min_child_weight=876; subsample=0.967; colsample_bytree=0.907; max_delta_step=7.52; tweedie_variance_power=1.63 : y = 57.7 : 7994.0 secs : infill_cb
# [mbo] 39: eta=0.00667; gamma=5.66; max_depth=16; min_child_weight=1721; subsample=0.934; colsample_bytree=0.652; max_delta_step=4.01; tweedie_variance_power=1.5 : y = 57.6 : 5539.5 secs : infill_cb
# $eta
# [1] 0.006673866
# 
# $gamma
