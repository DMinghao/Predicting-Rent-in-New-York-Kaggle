...
BoostTrainData <- xgb.DMatrix(as.matrix(BoostTrainData %>% select(-price)), label= as.matrix(BoostTrainData %>% select(price)))
...
obj.fun <- makeSingleObjectiveFunction(
  ...
  par.set = makeParamSet(
    ...
    makeNumericParam("gamma",                  lower = 1,     upper = 6),
...
do_bayes <- function(n_design = NULL, opt_steps = NULL, of = obj.fun, seed = seed) {
  set.seed(seed)
...
runs <- do_bayes(n_design = 15, of = obj.fun, opt_steps = 10, seed = seed)
